	...
	return (
		<div>
			<nav className="items-center justify-between hidden space-x-4 md:flex">
				...
				<div className="border border-solid border-[#F3F4F6] h-5"></div>
				<button
				...
				<button
					href="/path-to-cv.pdf"
					download
					className="px-4 py-2 text-center text-white bg-gray-900 rounded-xl dark:bg-white dark:text-gray-900"
				>
					Download CV
				</button>
			</nav>
